...
experimental:
  plugins:
    example:
      moduleName: github.com/7i11/traefik-geoip2
      version: v0.2.1
```
...
(In the above example, the `traefikgeoip2` plugin will be loaded from the path `./plugins-local/src/github.com/7i11/traefik-geoip2`.)
